<?php
  require_once"admin/connect.php";
    ...
    if (isset($_GET['post'])) {
      $post_get_id = $_GET['post'];
      $select_post = "SELECT * FROM posts WHERE post_id = $post_get_id";
...
<body>
 <div id="desktop_elements">
   ...
   <div class="content">
     <svg style="position:absolute; top:26vw; left:5vw;" height="22.5vw" width="40vw" viewBox="0 0 40 22.5">
       <image x="0" y="0" height="22.5" width="40" href="<?php echo $post_image; ?>"/>
     </svg>
     ...
     <text dominant-baseline="middle" text-anchor="middle" x="45" y="3" font-size="0.2rem" style="font-family:Silapakorn-Regular; fill:#fff;"> <?php echo $post_title; ?> </text>
     </svg>
     <text style="position:absolute; font-size:1.8vw; top:26vw; left:47vw; font-family:Silapakorn-Regular; color:#40826d;"> by <?php echo $post_author;?> on <?php echo $post_date;?> id: <?php echo $post_id;?> </text>
     <text style="position:absolute; font-size:1.8vw; top:50vw; left:8vw; font-family:Silapakorn-Regular; color:#40826d; width:80vw; line-height: 1.3; word-break: break-word; overflow:auto;"> <?php echo $post_content;?> </text>
</div>
</div>
 <div id="mobile_elements">

   <img style="position:absolute; top:35vw; left:10vw; height:50vw; width:80vw;" src="<?php echo $post_image; ?>"/>
 ...
 <text style="position:absolute; font-size:2vw; top:30vw; left:7vw; font-family:Silapakorn-Regular; color:#40826d;"> by <?php echo $post_author;?> on <?php echo $post_date;?> id: <?php echo $post_id;?> </text>
 <text style="position:absolute; font-size:3vw; top:87vw; left:8vw; font-family:Silapakorn-Regular; color:#40826d; width:80vw; line-height: 1.3; word-break: break-word; overflow:auto;"> <?php echo $post_content;?> </text>
