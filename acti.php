...
<body>
 <div id="desktop_elements">
   ...
   <svg style="position:absolute; top:18vw; left:5vw;" width="80vw" height="4vw" viewBox="0 0 80 4">
     <text x="0" y="3" style="font-size:0.2rem; font-family:Silapakorn-Regular;" fill="#1d5242">กิจกรรม</text>
   </svg>


   <?php
     $select_acti = "SELECT * FROM activities ORDER BY acti_date DESC";
    ...
    <div class="content">
      <svg style="position:absolute; top:<?php echo 25 + 12*$i?>vw; left:5vw;" height="18vw" width="90vw" viewBox="0 0 90 18">
        ...
        ?>"/>
        <image x="1.5" y="1.5" height="9" width="16" href="<?php echo $acti_image; ?>"/>
      </svg>
      <text style="position:absolute; font-size:2.5vw; top:<?php echo 26 + 12*$i?>vw; left:24vw; font-family:Silapakorn-Regular; color:#40826d; width:70vw; word-break: break-word; overflow:hidden;"> <?php echo $acti_title;?> </text>
      <text style="position:absolute; font-size:1.8vw; top:<?php echo 29 + 12*$i?>vw; left:24vw; font-family:Silapakorn-Regular; color:#60877b;"> by <?php echo $acti_author;?> on <?php echo $acti_date;?> id: <?php echo $acti_id;?> </text>
      <text style="position:absolute; font-size:1.5vw; top:<?php echo 31.5 + 12*$i?>vw; left:24vw; font-family:Silapakorn-Regular; color:#60877b; width:70vw; height:5vw; line-height: 1.3; word-break: break-word; overflow:auto;"> <?php echo $acti_content;?> </text>
      <a class="icon"href="activities.php?acti=<?php echo $acti_id?>">
        <svg style="position:absolute; top:<?php echo 25 + 12*$i?>vw; left:5vw;" height="18vw" width="90vw" viewBox="0 0 90 18">
 ...
 <div id="mobile_elements">
   ...
   <svg style="position:absolute; top:26vw; left:3vw;" width="80vw" height="8vw" viewBox="0 0 80 10">
     <text x="0" y="10" style="font-size:0.8rem; font-family:Silapakorn-Regular;" fill="#1d5242">กิจกรรม</text>
   </svg>
   ...
   while ($row = mysqli_fetch_array($query_acti)) {
    ...
    <div class="content">
      ...
      <text style="position:absolute; font-size:4vw; top:<?php echo 42 + 21*$i?>vw; left:39vw; font-family:Silapakorn-Regular; color:#40826d; width:50vw; height:5vw; word-break: break-word; overflow:hidden;"> <?php echo $acti_title;?> </text>
      <text style="position:absolute; font-size:2vw; top:<?php echo 47.5 + 21*$i?>vw; left:39vw; font-family:Silapakorn-Regular; color:#60877b;"> by <?php echo $acti_author;?> on <?php echo $acti_date;?> id: <?php echo $acti_id;?> </text>
      <text style="position:absolute; font-size:3vw; top:<?php echo 51 + 21*$i?>vw; left:39vw; font-family:Silapakorn-Regular; color:#60877b; width:50vw; height:7.2vw; line-height: 1.3; word-break: break-word; overflow:auto;"> <?php echo $acti_content;?> </text>
    <a class="icon" href="activities.php?acti=<?php echo $acti_id?>">
      <svg style="position:absolute; top:<?php echo 40 + 21*$i?>vw; left:5vw;" height="30vw" width="90vw" viewBox="0 0 50 18">
