<?php
  require_once"admin/connect.php";
    ...
    if (isset($_GET['acti'])) {
      $acti_get_id = $_GET['acti'];
      $select_acti = "SELECT * FROM activities WHERE acti_id = $acti_get_id";
...
<body>
 <div id="desktop_elements">
   ...
   <div class="content">
     <svg style="position:absolute; top:26vw; left:5vw;" height="22.5vw" width="40vw" viewBox="0 0 40 22.5">
       <image x="0" y="0" height="22.5" width="40" href="<?php echo $acti_image; ?>"/>
     </svg>
     <svg style="position:absolute; top:18vw; left:5vw;" width="90vw"viewBox="0 0 90 6">
       <rect x="0.5" y="0.5" width="89" height="5" fill="#ddd"/>
       <rect x="0" y="0" width="89" height="5" fill="#40826d"/>
     <text dominant-baseline="middle" text-anchor="middle" x="45" y="3" font-size="0.2rem" style="font-family:Silapakorn-Regular; fill:#fff;"> <?php echo $acti_title; ?> </text>
     </svg>
     <text style="position:absolute; font-size:1.8vw; top:26vw; left:47vw; font-family:Silapakorn-Regular; color:#40826d;"> by <?php echo $acti_author;?> on <?php echo $acti_date;?> id: <?php echo $acti_id;?> </text>
     <text style="position:absolute; font-size:1.8vw; top:50vw; left:8vw; font-family:Silapakorn-Regular; color:#40826d; width:80vw; line-height: 1.3; word-break: break-word; overflow:auto;"> <?php echo $acti_content;?> </text>
 ...
 <div id="mobile_elements">
   ...
   <img style="position:absolute; top:35vw; left:10vw; height:50vw; width:80vw;" src="<?php echo $acti_image; ?>"/>

 <svg style="position:absolute; top:20vw; left:5vw;" width="90vw"viewBox="0 0 90 10">
   <rect x="0.5" y="0.5" width="89" height="9" fill="#ddd"/>
   <rect x="0" y="0" width="89" height="9" fill="#40826d"/>
 <text dominant-baseline="middle" text-anchor="middle" x="45" y="5" font-size="0.24rem" style="font-family:Silapakorn-Regular; fill:#fff;"> <?php echo $acti_title; ?> </text>
 </svg>
 <text style="position:absolute; font-size:2vw; top:30vw; left:7vw; font-family:Silapakorn-Regular; color:#40826d;"> by <?php echo $acti_author;?> on <?php echo $acti_date;?> id: <?php echo $acti_id;?> </text>
 <text style="position:absolute; font-size:3vw; top:87vw; left:8vw; font-family:Silapakorn-Regular; color:#40826d; width:80vw; line-height: 1.3; word-break: break-word; overflow:auto;"> <?php echo $acti_content;?> </text>
