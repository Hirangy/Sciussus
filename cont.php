...
<body>
 <div id="desktop_elements">
   ...
   <div>
     <img style="position:absolute; top:0vw;" width= "100%" src="img/sciussu cont plan.svg">
 ...
 <div id="mobile_elements">
   ...
   <div class="crop">
     <img style="position:absolute; top:0vw;" width= "100%"src="img/sciussu cont plan mobile.svg">
   </div>
   ...
   <div class="mobile_menubar">
     ...
     <div id="mobile_iconlang">
       <div class="icon">
         <a href="cont-en.php" height="15vw" width="15vw">
